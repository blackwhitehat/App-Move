...
import com.arikehparsi.reyhanh.yedarbast.MainActivity;
import com.arikehparsi.reyhanh.yedarbast.R;

public class Game_SeriesResult extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_game__series_result);
