...
public class Game_PlayGameWithComputer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game__play_game_with_computer);
        ...
        displayTurn=player1Name + "نوبت  (X)";
    ...
    public void playmove(View view) {
        ...
        if (turn == 1 && gamov == 0 && !(playBoard[i][j].getText().toString().equals("X")) && !(playBoard[i][j].getText().toString().equals("O"))) {
            ...
            if(flipValue==0){
                displayTurn=player2Name + "نوبت  (O)";
            ...
            if(flipValue==1){
                displayTurn=player2Name + "نوبت  (X)";
                playerTurn.setText(displayTurn);
                ...
                moveNumber++;
                computerPlay();
                displayTurn=player1Name + "نوبت (O)";
                turn = 2;
                moveNumber++;
        ...
        if (gamov == 1) {
            if (win == 1) {
                builder.setMessage(player1Name + " برنده !").setTitle("Game over");
                if(flagEndGame==0){
                    player1Win++;
                    counter++;
                }
                ...
                builder.setMessage(player2Name + " برنده !").setTitle("Game over");
                if(flagEndGame==0){
                    player2Win++;
                    counter++;
                }
            ...
            builder.setPositiveButton("OK",new DialogInterface.OnClickListener(){
                public void onClick(DialogInterface dialog, int id){
                    ...
                    if (counter == number) {
                        Intent intent = new Intent(getApplicationContext(), Game_SeriesResult.class);
...
//                    counter++;
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://com.arikehparsi.reyhanh.yedarbast/http/host/path")
        );
