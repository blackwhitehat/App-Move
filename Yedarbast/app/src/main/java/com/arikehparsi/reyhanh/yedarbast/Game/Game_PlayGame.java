...
public class Game_PlayGame extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game__play_game);
    ...
    public void playmove(View view) {
        ...
        if (gamov == 1) {
            if (win == 1) {
                builder.setMessage(player1Name + " برنده شد!").setTitle("Game over");
                if(flagEndGame==0){
                    player1Win++;
                    counter++;
                }
                ...
                builder.setMessage(player2Name + " برنده شد!").setTitle("Game over");
                if(flagEndGame==0){
                    player2Win++;
                    counter++;
                }
        ...
        if (gamov == 0) {
            ...
            if (flag == 0) {
                builder.setMessage("مساوی!!").setTitle("Game over");
                if(flagEndGame==0){
                    counter++;
                    draw++;
                }
    ...
    public void newGame(View view) {
        ...
        if(flipValue==0){
            ...
            if(flagEndGame==1){
                ...
                displayTurn=player2Name + "توبت  (X)";
                playerTurn.setText(displayTurn);
            }
