...
public class Game_PlayerName extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_game__player_name);
    }
...
//        }
            ...
            Intent intent = new Intent(this,Game_PlayGame.class);
